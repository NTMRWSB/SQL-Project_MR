...
CREATE TABLE IF NOT EXISTS tb_goods (
	...
	CONSTRAINT companyid_for_tb_goods FOREIGN KEY(companyid) REFERENCES tb_company(companyid),
	--操作用户
	username VARCHAR(255) NOT NULL,
	--添加/修改时间
	add_time DATETIME NULL DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS tb_stock (
	...
	CONSTRAINT goodsid_for_tb_stock FOREIGN KEY(goodsid) REFERENCES tb_goods(goodsid),
	--数量
	num INT NOT NULL,
	--操作用户
	username VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS tb_order (
	...
	--商品ID 外键
	goodsid INT UNSIGNED,
	CONSTRAINT goodsid_for_tb_order FOREIGN KEY(goodsid) REFERENCES tb_goods(goodsid),
	--交易数量
	num INT NOT NULL,
	--交易方式
